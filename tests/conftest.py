"""pytest configuration for the Cainiao test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.cainiao`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.cainiao import parcels
